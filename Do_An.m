classdef Do_An < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        NhpcntnhtchphnEditField       matlab.ui.control.EditField
        ...
        TrnMinhTrPhanNguynThanhTngLabel  matlab.ui.control.Label
        ThnhvirnnhmLabel              matlab.ui.control.Label
    end
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.NhpcntnhtchphnEditField.Value = '0 3.14159';
    ...
    methods (Access = private)
        ...
        function TnhButton_4Pushed(app, event)
            ...
            strLimit = app.NhpcntnhtchphnEditField.Value;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            ylabel(app.UIAxes, 'Y')
            zlabel(app.UIAxes, 'Z')
            app.UIAxes.Position = [343 212 374 237];
            ...
            app.ChnphngphpDropDownLabel.Position = [64 212 136 22];
            ...
            app.ChnphngphpDropDown.Position = [215 212 100 22];
            app.ChnphngphpDropDown.Value = 'Chia đôi';
            ...
            app.NhpsaischophpEditFieldLabel.Position = [65 270 150 22];
            ...
            app.NhpsaischophpEditField.Position = [228 270 100 22];
            ...
            app.NhpkhongphnlynghimEditFieldLabel.Position = [13 312 201 22];
            ...
            app.NhpkhongphnlynghimEditField.Position = [227 312 100 22];
            ...
            app.TnhButton.Position = [490 102 100 25];
            ...
            app.NhpphngtrnhEditFieldLabel.Position = [80 358 133 22];
            ...
            app.NhpphngtrnhEditField.Position = [228 358 100 22];
            ...
            app.UIAxes2.Position = [310 212 391 251];
            ...
            app.NhpgitrxEditFieldLabel.Position = [75 383 102 22];
            ...
            app.NhpgitrxEditField.Position = [192 383 100 22];
            ...
            app.NhpgitryEditFieldLabel.Position = [75 339 102 22];
            ...
            app.NhpgitryEditField.Position = [192 339 100 22];
            ...
            app.NhpgitrcnnisuyEditFieldLabel.Position = [6 291 171 22];
            ...
            app.NhpgitrcnnisuyEditField.Position = [192 291 100 22];
            ...
            app.KtquathcnisuyTextAreaLabel.Position = [7 131 164 22];
            ...
            app.ChnphngphpDropDown_2Label.Position = [115 239 136 22];
            ...
            app.ChnphngphpDropDown_2.Position = [105 194 156 22];
            app.ChnphngphpDropDown_2.Value = 'Nội suy Newton';
            ...
            app.KtquathcnisuyTextArea.Position = [184 112 150 60];
            ...
            app.KtqunisuyTextAreaLabel.Position = [37 56 109 22];
            ...
            app.KtqunisuyTextArea.Position = [182 30 150 60];
            ...
            app.TnhButton_2.Position = [480 102 100 25];
            ...
            app.UIAxes2_2.Position = [311 187 391 251];
            ...
            app.TnhButton_3.Position = [311 122 112 35];
            ...
            app.NhpgitrxEditField_2Label.Position = [76 358 102 22];
            ...
            app.NhpgitrxEditField_3.Position = [193 358 100 22];
            ...
            app.NhpgitryEditField_2Label.Position = [76 314 102 22];
            ...
            app.NhpgitryEditField_3.Position = [193 314 100 22];
            ...
            app.NhpgitrcndonEditFieldLabel.Position = [0 266 178 22];
            ...
            app.NhpgitrcndonEditField.Position = [193 266 100 22];
            ...
            app.KtquathchiquyTextAreaLabel.Position = [50 124 165 22];
            ...
            app.KtquathchiquyTextArea.Position = [23 48 263 60];
            ...
            app.KtqudonTextAreaLabel.Position = [515 128 116 22];
            ...
            app.KtqudonTextArea.Position = [453 48 241 60];
            ...
            app.ChnphngphpDropDown_3Label.Position = [89 222 136 22];
            ...
            app.ChnphngphpDropDown_3.Position = [80 181 156 22];
            app.ChnphngphpDropDown_3.Value = 'Tuyến tính';
            ...
            app.TnhButton_4.Position = [43 132 119 38];
            ...
            app.NhpgitryEditField_4Label.Position = [45 352 102 22];
            ...
            app.NhpgitryEditField_4.Position = [162 352 99 22];
            ...
            app.NhpgitrxEditField_4Label.Position = [45 404 102 22];
            ...
            app.NhpgitrxEditField_4.Position = [162 404 99 22];

            % Create NhpcntnhtchphnEditFieldLabel
            app.NhpcntnhtchphnEditFieldLabel = uilabel(app.TchphnTab);
            app.NhpcntnhtchphnEditFieldLabel.HorizontalAlignment = 'right';
            app.NhpcntnhtchphnEditFieldLabel.FontSize = 14;
            app.NhpcntnhtchphnEditFieldLabel.FontWeight = 'bold';
            app.NhpcntnhtchphnEditFieldLabel.Position = [359 353 197 22];
            app.NhpcntnhtchphnEditFieldLabel.Text = 'Nhập cận để tính tích phân:  ';

            % Create NhpcntnhtchphnEditField
            app.NhpcntnhtchphnEditField = uieditfield(app.TchphnTab, 'text');
            app.NhpcntnhtchphnEditField.FontSize = 14;
            app.NhpcntnhtchphnEditField.FontWeight = 'bold';
            app.NhpcntnhtchphnEditField.Position = [571 353 100 22];
            ...
            app.NhphmsEditFieldLabel.Position = [47 260 101 22];
            ...
            app.NhphmsEditField.Position = [163 260 99 22];
            ...
            app.NhpNEditFieldLabel.Position = [502 301 54 22];
            ...
            app.NhpNEditField.Position = [571 301 100 22];
            ...
            app.ChnphngphpDropDown_4Label.Position = [389 404 136 22];
            ...
            app.ChnphngphpDropDown_4.Position = [540 404 131 22];
            ...
            app.KtquTextAreaLabel.Position = [435 222 56 22];
            ...
            app.NhpdliuxEditFieldLabel.Position = [53 398 111 22];
            ...
            app.NhpdliuxEditField.Position = [179 398 100 22];
            ...
            app.NhphmsEditField_2Label.Position = [63 264 101 22];
            ...
            app.NhphmsEditField_2.Position = [179 264 100 22];
            ...
            app.NhpdliuyEditFieldLabel.Position = [53 354 111 22];
            ...
            app.NhpdliuyEditField.Position = [179 354 100 22];
            ...
            app.NhpbchEditFieldLabel.Position = [63 223 101 22];
            ...
            app.NhpbchEditField.Position = [179 223 100 22];
            ...
            app.ChngitrsaisOhDropDownLabel.Position = [17 150 159 22];
            ...
            app.ChngitrsaisOhDropDown.Position = [191 150 100 22];
            ...
            app.ChnphngphpohmDropDownLabel.Position = [332 398 199 22];
            ...
            app.ChnphngphpohmDropDown.Position = [546 398 113 22];
            ...
            app.KtquTextArea_2Label.Position = [344 264 65 22];
            ...
            app.NhpgitrcntnhohmLabel.Position = [332 342 211 22];
            ...
            app.NhpgitrcntnhohmEditField.Position = [558 342 100 22];
            ...
            app.TnhButton_5.Position = [293 55 134 47];

            % Create GiithiuTab
            app.GiithiuTab = uitab(app.TabGroup);
            app.GiithiuTab.Title = 'Giới thiệu';

            % Create ThnhvirnnhmLabel
            app.ThnhvirnnhmLabel = uilabel(app.GiithiuTab);
            app.ThnhvirnnhmLabel.HorizontalAlignment = 'center';
            app.ThnhvirnnhmLabel.FontSize = 15;
            app.ThnhvirnnhmLabel.Position = [262 395 130 43];
            app.ThnhvirnnhmLabel.Text = 'Thành viêrn nhóm:';

            % Create TrnMinhTrPhanNguynThanhTngLabel
            app.TrnMinhTrPhanNguynThanhTngLabel = uilabel(app.GiithiuTab);
            app.TrnMinhTrPhanNguynThanhTngLabel.HorizontalAlignment = 'center';
            app.TrnMinhTrPhanNguynThanhTngLabel.FontSize = 15;
            app.TrnMinhTrPhanNguynThanhTngLabel.Position = [236 363 180 37];
            app.TrnMinhTrPhanNguynThanhTngLabel.Text = {'Trần Minh Trí'; 'Phan Nguyễn Thanh Tùng'};
